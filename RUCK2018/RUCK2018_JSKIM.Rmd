...
```{r, out.width= "50%", fig.cap = "https://subicura.com/2017/01/19/docker-guide-for-beginners-1.html"}
...
> 서버의 **종류와 갯수**에 구애받지 않는  **마이크로서비스 아키텍처**(microservice architecture)를 구축하였으며...
...
2개 서버: **manager, worker** node



1. Init Docker Swarm mode: In **manager** node
...
3. Join worker nodes: In **worker** node
...
- **GEE, linear mixed model, GLMM** : 자체 패키지 [`jstable`](https://github.com/jinseob2kim/jstable) 로 결과테이블 생성
...
```{r, out.width= "70%", fig.cap = "https://cdn-ak.f.st-hatena.com/images/fotolife/k/ksmzn/20171209/20171209204102.gif"}
...
1. [기본 앱 모음](http://147.47.68.165:2222/navbar)

2. [건강설문조사 리포트](http://147.47.68.165:2222/health-report)

3. [대장암 환자 연구: 강릉아산병원](http://147.47.68.165:2222/yschoi)

4. [이완기 압력 계산: 삼성서울병원](http://147.47.68.165:2222/chkh/dPR)

5. [다중 언어: 한/영](http://147.47.68.165:2222/shiny.i18n)
